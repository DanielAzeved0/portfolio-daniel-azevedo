    ...
    <section id="contact" className={`${SECTION_STYLES.container} bg-[var(--foreground)]`}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex gap-6 justify-center flex-wrap">
          <a href={`mailto:${PERSONAL_INFO.email}`} className={BUTTON_STYLES.ghost} aria-label="Enviar email">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            Email
          </a>
          <a href={PERSONAL_INFO.github} target="_blank" rel="noopener noreferrer" className={BUTTON_STYLES.ghost} aria-label="Visitar GitHub">
          ...
          <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noopener noreferrer" className={BUTTON_STYLES.ghost} aria-label="Visitar LinkedIn">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
