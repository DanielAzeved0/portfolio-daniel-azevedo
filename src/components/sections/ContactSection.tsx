  ...
  return (
    <section id="contact" className={`${SECTION_STYLES.container} bg-[var(--foreground)]`}>
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-12 text-[var(--background)]">Entre em Contato</h2>
        <p className="text-[var(--background)] text-lg mb-8">
          Estou disponível para oportunidades de estágio, projetos freelance ou apenas para
