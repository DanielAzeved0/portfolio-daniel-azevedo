        ...
        <div className="mb-8">
          ...
          <div className="grid gap-4">
            {EDUCATION.map((education) => (
              <div key={`${education.degree}-${education.period}`} className="bg-[#E0E0E0] p-8 rounded-2xl border border-[#333333]/20 shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {education.institution && (
                      <p className="text-[#333333] font-semibold mb-1">{education.institution}</p>
                    )}
