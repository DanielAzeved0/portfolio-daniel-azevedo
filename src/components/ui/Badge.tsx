...
const variantClasses: Record<BadgeVariant, string> = {
  primary:
    "inline-block rounded-full bg-[var(--accent-secondary)] px-3 py-1 text-xs font-bold text-white",
  ...
  outline:
    "inline-flex rounded-full border border-[rgba(74,144,226,0.3)] px-3 py-1 text-xs font-bold text-[var(--accent-primary)]",
};
